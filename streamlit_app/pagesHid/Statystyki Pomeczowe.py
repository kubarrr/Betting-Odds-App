...
def load_data():
    ...
    players_pl = pd.read_csv("../data/players_pl.csv")
    players_ll = pd.read_csv("../data/players_ll.csv")
    players_sa = pd.read_csv("../data/players_sa.csv")
    players_bl = pd.read_csv("../data/players_bl.csv")
    players_l1 = pd.read_csv("../data/players_l1.csv")
    players_new = pd.read_csv("../data/new_players.csv")
...
sumi = 0
for prob, color in zip(probabilities2, colors):
    ax.text(start + prob / 2, 0, f"{int(round(prob * 100))}%", color='black', va='center', ha='center', fontsize=14)
    start += prob
...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Informacje", "Statystyki", "Składy", "Kursy bukmacherskie", "Analiza"])
